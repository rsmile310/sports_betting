...
const Subscribe = () => {
  ...
  return (
    <div className='min-h-screen flex flex-col w-full bg-[#0d155a] text-white'>
        <NavBar />
        <h2 className="text-center mx-auto font-bold text-2xl pt-2 border-b-2">SUBSCRIBE</h2>
        <div className="flex pb-6 xtab:flex-row flex-col items-center mx-auto tablet:w-4/5  xtab:w-3/5 w-full tablet:px-0 px-2">
            <form className="mt-[11vh] tablet:min-w-[400px] min-w-[250px] max-w-[450px] py-[11vh] rounded-md mx-auto w-4/5 p-6 flex flex-col px-[10%]" style={{background: isPhone? '':'linear-gradient(211.55deg, #6C348E 2.86%, #81CEF0 58.74%, #E27BB2 89.39%)'}} >
                <div className="mt-4 flex flex-col w-full">
                    <label htmlFor="surname">Name Surname</label>
                    <input className='text-black mt-2 rounded-md bg-white w-full outline-none shadow-md px-3 p-2 text-lg' type="text" />
                </div>
                <div className="mt-4 flex flex-col w-full">
                ...
                <div className="mt-4 flex flex-col w-full">
                    ...
                    <input className='text-black mt-2 rounded-md bg-white w-full outline-none shadow-md px-3 p-2 text-lg' type="password" />
                </div>
                ...
                <div className="mt-9 flex w-full items-center justify-center">
                  ...
                  <button>
                    <img className='w-[40px] ml-4 -translate-y-1' src={apple} alt="apple" />
                  </button>
                </div>
            </form>
        </div>
